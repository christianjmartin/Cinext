...
const DATA = () => {
    ...
    return (
        ...
        <View style={[styles.container, {backgroundColor: currentTheme.background}]}>
            <Text style={[styles.infoContainer, {color: currentTheme.textColorSecondary}]}>All data used by MovieNext, including Posters, Titles, Directors, Descriptions, Ratings and Dates is provided by TMDB (The Movie Database)</Text>
