        ...
        <ScrollView style={[styles.container, {backgroundColor: currentTheme.background}]}>
            <View style={{alignItems: 'center'}}>
                ...
                <View style={styles.QA}>
                    ...
                    <Text style={[styles.infoContainer, {color: currentTheme.textColorSecondary}]}>If too many movies were filtered from the recommendations, we need to get more to satisfy the request to provide the best suggestions possible.</Text>
                </View>
                <View style={styles.QA}>
